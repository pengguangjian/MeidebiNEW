...
//        [NSTimer scheduledTimerWithTimeInterval:1.5 target:self selector:@selector(timeerit) userInfo:nil repeats:NO];
...
-(void)timeerit
{
    ...
    v.image = img;
    [v setCenter:CGPointMake(BOUNDS_WIDTH/2.0, 0)];
...
-(void)messageNumtimeerit
{
    ...
    [_lbmessagenum setCenter:CGPointMake(BOUNDS_WIDTH-20, 15)];
