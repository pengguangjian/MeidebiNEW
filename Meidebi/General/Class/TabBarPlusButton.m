...
//  Meidebi
//
//  Created by mdb-losaic on 2018/6/28.
...
@interface TabBarPlusButton ()<UIActionSheetDelegate> {
...
+ (id)plusButton {
    ...
    UIImage *buttonImage = [UIImage imageNamed:@"yijiandaigou_normal"];
    [button setImage:buttonImage forState:UIControlStateNormal];
    [button setTitle:@"一键代购" forState:UIControlStateNormal];
    [button setTitleColor:[UIColor grayColor] forState:UIControlStateNormal];
    
    [button setTitle:@"一键代购" forState:UIControlStateSelected];
