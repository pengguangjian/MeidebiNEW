//
//  JoinInActivityPickPictureView.m
//  Meidebi
//
...
#import "PictureHandleCollectionViewCell.h"
...
@interface JoinInActivityPickPictureView ()
<
...
@implementation JoinInActivityPickPictureView
...
- (void)setupSubviews{
    ...
    [_collectionView registerClass:[PictureHandleCollectionViewCell class] forCellWithReuseIdentifier:@"cell"];
...
- (void)updatePictureView{
    ...
    frame.size.height = _collectionView.collectionViewLayout.collectionViewContentSize.height + _margin+8;
    self.frame = frame;
}
...
- (NSInteger)collectionView:(UICollectionView *)collectionView numberOfItemsInSection:(NSInteger)section {
    return _selectedPhotos.count == maxPictureNumber ? _selectedPhotos.count:_selectedPhotos.count + 1;
}

- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    PictureHandleCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"cell" forIndexPath:indexPath];
    cell.videoImageView.hidden = YES;
    if (indexPath.row == _selectedPhotos.count) {
        cell.imageView.image = [UIImage imageNamed:@"picture_add"];
...
- (void)pushImagePickerController {
    ...
    TZImagePickerController *imagePickerVc = [[TZImagePickerController alloc] initWithMaxImagesCount:maxPictureNumber columnNumber:4 delegate:self pushPhotoPickerVc:YES];
...
//            NSURL *privacyUrl;
//            if (alertView.tag == 1) {
//                privacyUrl = [NSURL URLWithString:@"App-Prefs:root=Privacy&path=PHOTOS"];
//            } else {
//                privacyUrl = [NSURL URLWithString:@"App-Prefs:root=Privacy&path=CAMERA"];
//            }
...
- (void)deleteBtnClik:(UIButton *)sender {
    ...
    [_collectionView performBatchUpdates:^{
        if (_selectedPhotos.count != maxPictureNumber-1) {
