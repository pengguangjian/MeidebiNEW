//
//  ZiZhuDaiGouHomeViewController.m
//  Meidebi
//
...
@interface ZiZhuDaiGouHomeViewController ()

@end

@implementation ZiZhuDaiGouHomeViewController
...
-(void)drawSubview
{
    ZiZhuDaiGouHomeView *zview = [[ZiZhuDaiGouHomeView alloc] init];
