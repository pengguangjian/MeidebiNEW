...
- (void)updateContent {
    ...
    if (_isDelete) {
        ...
        } else if (_emoticon.group.groupID ){
            if ([_emoticon.png isEqualToString:@""]) {
                _imageView.image = [UIImage imageNamed:_emoticon.gif];
            }else{
                _imageView.image = [UIImage imageNamed:_emoticon.png];
            }
//            NSString *pngPath = [[RemarkStatusHelper emoticonBundle] pathForScaledResource:_emoticon.png ofType:nil inDirectory:_emoticon.group.groupID];
//            if (!pngPath) {
//                NSString *addBundlePath = [[RemarkStatusHelper emoticonBundle].bundlePath stringByAppendingPathComponent:@"additional"];
...
#pragma mark - EmoticonScrollView
...
@interface RemarkEmoticonInputView ()
<
UICollectionViewDelegate,
UICollectionViewDataSource,
UIInputViewAudioFeedback,
EmoticonScrollViewDelegate
>
...
@end
@implementation RemarkEmoticonInputView

+ (instancetype)sharedInstance {
    static RemarkEmoticonInputView *v;
...
- (void)_initGroups {
    _emoticonGroups = [RemarkStatusHelper emoticonGroups];
...
- (void)_initCollectionView {
    ...
    _collectionView = [[EmoticonScrollView alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth, kOneEmoticonHeight * 3) collectionViewLayout:layout];
